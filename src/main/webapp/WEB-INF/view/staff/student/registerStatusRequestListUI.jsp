...
<!-- 학적변동  신청 상세보기 모달 -->
	<div class="modal fade" id="requestModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel01" aria-hidden="true">
	    <div class="modal-dialog modal-xl" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="modalLabel01">학적변동 신청</h5>
	              <button id="requestModal-close" class="close" type="button" data-bs-dismiss="modal" aria-label="Close">
					    <span aria-hidden="true">×</span>
				  </button>

	            </div>
	            <div class="requestModal-body">
	            </div>
	        </div>
	    </div>
	</div>
	            	...
	            	<div class="modal-body" style="padding:20px;">
						...
						<div>
							<form id="refusedRequest" action="/staff/club/updateRefusedClubRequest" method="post">
								...
								<input type="hidden" id="returnSknrgNo" name="sknrgNo">
