	    ...
	    <div class="modal-dialog modal-xl" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="modalLabel01">취업 상담 신청</h5>
...
<!-- 반려 사유 입력하는 모달 -->
	<div class="modal fade mt-100" id="consultationRefuseModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel01" aria-hidden="true">
	    <div class="modal-dialog modal-xl" role="document" id="secondModal">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="modalLabel01">상담 신청 반려</h5>
	              <button id="consultationRefuseModalClose" class="close" type="button" data-bs-dismiss="modal" aria-label="Close">
					    <span aria-hidden="true">×</span>
				  </button>
	            </div>
	            <div>
	            	<div class="modal-body" style="padding:20px;">
						...
						<div>				
							<form id="refusedConsultationRequest" action="/staff/consultation/updateRefusedConsultationRequest" method="post">
		...
		<div id="searchUI" class="sub_top_wrap">
			...
			<div class="search_bottom">
				...
				<div class="s_option02 mr-4 ft-left">
					...
					<div class="select-container">
						<select class="custom-select02 searchFormUIInput" name="cnsltRequstProcess">
							<option value="" label="전체">
...
<form action="<c:url value='/staff/consultation/ajax/consultationRequest'/>" id="searchForm">
	...
	<input type="hidden" name="cnsltRequstProcess">
	<input type="hidden" name="page">
</form>

<script src="/resources/js/app/msy/staffConsultationRequest.js"></script>
