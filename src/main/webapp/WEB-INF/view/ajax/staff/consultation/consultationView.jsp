		...
		<div class="pro_table">
			...
			<div>
				<table class="table_style02 table_center">
					...
					<tr>
						<td style="text-align:left; padding-left:10px; padding-right:10px;">${consultationInfo.cnsltDtls}</td>
					</tr>			
				</table>
			</div>
		</div>
  		<br />
  		<div>
			<button class="btn btn-primary ft_right" id="consultationModifyBtn" type="button" data-consultation-no="${consultationInfo.cnsltNo}">수정</button>
		</div>
	</div>
 </div>