		...
		<div class="pro_table">
			...
			<div>
				<table class="table_style02 table_center">
					...
					<tr>
						<td style="text-align:left; padding-left:10px; padding-right:10px;">${consultationRequestInfo.cnsltRequstCn}</td>
					</tr>			
				</table>
				<input type="hidden" value="${consultationRequestInfo.cnsltNo}" id="hiddenCnsltNo">
			</div>
			...
			<c:if test="${consultationRequestInfo.cnsltRequstProcess eq '승인 대기'}">
				...
				<div>
					...
					<button class="btn btn-danger ft_right" id="refuseBtn" data-toggle="modal" data-target="consultationRefuseModal">반려</button>
